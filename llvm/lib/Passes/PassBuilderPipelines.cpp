...
PassBuilder::buildO1FunctionSimplificationPipeline(OptimizationLevel Level,
  ...
  //LPM1.addPass(LICMPass(PTO.LicmMssaOptCap, PTO.LicmMssaNoAccForPromotionCap,/*AllowSpeculation=*/false));

  LPM1.addPass(LoopRotatePass(/* Disable header duplication */ true,
                              isLTOPreLink(Phase)));
  // TODO: Investigate promotion cap for O1.
  //LPM1.addPass(LICMPass(PTO.LicmMssaOptCap, PTO.LicmMssaNoAccForPromotionCap, /*AllowSpeculation=*/true));
...
PassBuilder::buildFunctionSimplificationPipeline(OptimizationLevel Level,
  ...
  //FPM.addPass(createFunctionToLoopPassAdaptor(LICMPass(PTO.LicmMssaOptCap, PTO.LicmMssaNoAccForPromotionCap, /*AllowSpeculation=*/true), /*UseMemorySSA=*/true, /*UseBlockFrequencyInfo=*/false));
...
void PassBuilder::addVectorPasses(OptimizationLevel Level,
  ...
  if (Level.getSpeedupLevel() > 1 && ExtraVectorizerPasses) {
    ...
    LoopPassManager LPM;
    //LPM.addPass(LICMPass(PTO.LicmMssaOptCap, PTO.LicmMssaNoAccForPromotionCap, /*AllowSpeculation=*/true));
...
PassBuilder::buildModuleOptimizationPipeline(OptimizationLevel Level,
  ...
  if (UseLoopVersioningLICM) {
    ...
    //OptimizePM.addPass(createFunctionToLoopPassAdaptor(LICMPass(PTO.LicmMssaOptCap, PTO.LicmMssaNoAccForPromotionCap, /*AllowSpeculation=*/true), /*USeMemorySSA=*/true, /*UseBlockFrequencyInfo=*/false));
  }
...
PassBuilder::buildLTODefaultPipeline(OptimizationLevel Level,
  ...
  MainFPM.addPass(createFunctionToLoopPassAdaptor(LICMPass(PTO.LicmMssaOptCap, PTO.LicmMssaNoAccForPromotionCap,/*AllowSpeculation=*/true),/*USeMemorySSA=*/true, /*UseBlockFrequencyInfo=*/false));
